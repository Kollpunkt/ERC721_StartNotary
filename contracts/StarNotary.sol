...
contract StarNotary is ERC721 {
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory, string memory) {
        ...
        return(tokenIdToStarInfo[_tokenId].name, tokenIdToStarInfo[_tokenId].symbol);
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((ownerAddress1 == msg.sender) || (ownerAddress2 == msg.sender) , "Sender doesnt own either of the Stars!");
        ...
        //If either star was up for sale before the exchange, take it off the sales list
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address ownerAddress = ownerOf(_tokenId); 
        require((ownerAddress == msg.sender) , "You dont own the star you want to send");
        
        //Use the transferFrom(from, to, tokenId); function to transfer the Star
       _transferFrom(ownerAddress, _to1, _tokenId);

        //If star was up for sale before the exchange, take it off the sales list
